...
img2= cv.flip(img1, 1) #1: Flip horizont 0: Vertical -1: Flip both H and V
...
cv.imwrite('C:\\Users\\JARVIS\\Documents\\Tech drive\\Dissertation\\2024_new\\output images\\matchOut\\siftFlann\\siftflann.jpg', img3)  # Save the image
cv.imshow('Matched Features', img3)
cv.waitKey(0)  # Display each image for 1.5 seconds
